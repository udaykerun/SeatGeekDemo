...
#define SGHTTPREQUEST "SGHTTPRequest.h"
#endif
#import SGHTTPREQUEST



//! Project version number for SeatGeekAPI.
FOUNDATION_EXPORT double SeatGeekAPIVersionNumber;

//! Project version string for SeatGeekAPI.
FOUNDATION_EXPORT const unsigned char SeatGeekAPIVersionString[];

// In this header, you should import all the public headers of your framework using statements like #import <SeatGeekAPI/PublicHeader.h>
